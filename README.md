...
- [data/calibration_reviews.json](data/calibration_reviews.json): public calibration review set comparing gold labels to reviewer decisions
- [scripts/calibration_metrics.py](scripts/calibration_metrics.py): dependency-free agreement, kappa, and score-error script
- [outputs/calibration-metrics.md](outputs/calibration-metrics.md): calibration report with agreement rate and review flags
